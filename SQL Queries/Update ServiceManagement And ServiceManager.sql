...
     		  ,DisplayStringFromSource.[SourceID]
	FROM [ServiceManagementOld].[dbo].[DisplayString] as DisplayStringFromSource
...
INSERT INTO [ServiceManagement].dbo.NavigationNode
	...
	FROM [ServiceManagementOld].[dbo].[NavigationNode] as NavigationNodeSourceServer
...
inner join [ServiceManagementOld].[dbo].[NavigationNode] as NavigationNodeSourceServer
...
INSERT INTO [ServiceManagement].dbo.[GroupMapping_CI$DomainGroup_NavigationNode]
	...
	FROM [ServiceManagementOld].[dbo].[GroupMapping_CI$DomainGroup_NavigationNode] as NavigationNodeAccessSourceServer
...
INSERT INTO [ServiceManagement].dbo.ViewPanel
	...
	FROM [ServiceManagementOld].[dbo].[ViewPanel] as ViewPanelSourceServer
...
--Insert DataSourceConfiguration rows that are unsealed, and on the source server, and that do not 
	...
	FROM [ServiceManagementOld].[dbo].[DataSourceConfiguration] as DataSourceConfigurationSourceServer 
	left outer join [ServiceManagement].dbo.[DataSourceConfiguration]  as DataSourceConfigurationTargetServer
		on DataSourceConfigurationSourceServer.Name = DataSourceConfigurationTargetServer.Name
...
--Select only the DataSource rows that don't exist on the target server. Also, account for a differing DataSource Id between the two databases.
	...
	FROM [ServiceManagementOld].[dbo].[DataSource] as DataSourceSourceServer 
	...
	inner join [ServiceManagementOld].dbo.DataSourceConfiguration as DataSourceConfigurationSourceServer
	...
	inner join  [ServiceManagement].dbo.DataSourceConfiguration as DataSourceConfigurationTargetServer
		on DataSourceConfigurationTargetServer.Name = DataSourceConfigurationSourceServer.Name
...
INSERT [ServiceManagement].[dbo].[Enumeration] 
	(EnumerationID ,ParentEnumerationID ,CreatedBy ,CreatedDate ,Enabled ,Ordinal ,SourceID )
		...
		FROM [ServiceManagementOld].[dbo].[Enumeration] as EnumerationFromSource
...
INSERT [ServiceManagement].[dbo].[KnowledgeArticle] --cannot use a join in an insert into with an identity_insert
	([ArticleID] ,[Title] ,[Abstract] ,[Keywords] ,[EndUserContent] ,[EndUserContentType] ,[AnalystContent] ,[AnalystContentType] ,[ExternalURLSource] ,[ExternalURL] ,[LocaleID] ,[VendorArticleID] ,[Popularity] ,[Owner] ,[Status] ,[Type] ,[Category] ,[CreatedBy] ,[CreatedDate] ,[LastModifiedBy] ,[LastModifiedDate] ,[ExternalId] ,[SourceID] ,[IsImported] ,[ViewCount])
		...
		FROM [ServiceManagementOld].[dbo].[KnowledgeArticle] as KnowledgeArticleFromSource
...
INSERT [ServiceManagement].[dbo].[KnowledgeArticle$Comment]
	...
	FROM [ServiceManagementOld].[dbo].[KnowledgeArticle$Comment] as KACommentsFromSource
	left outer join [ServiceManagement].[dbo].[KnowledgeArticle$Comment] as KACommentsFromTarget
		...
		AND KACommentsFromSource.[Comment] = KACommentsFromTarget.[Comment]
...
INSERT [ServiceManagement].[dbo].[KnowledgeArticle$Rating]
	...
	FROM [ServiceManagementOld].[dbo].[KnowledgeArticle$Rating] as KARatingsFromSource
...
INSERT INTO [ServiceManagement].[dbo].[Relates_RequestOffering_KnowledgeArticle]
  ...
  FROM [ServiceManagementOld].[dbo].[Relates_RequestOffering_KnowledgeArticle] as KnowledgeArticleRequestOfferingsFromSource
...
INSERT INTO [ServiceManagement].[dbo].[Relates_ServiceOffering_KnowledgeArticle]
  ...
  FROM [ServiceManagementOld].[dbo].[Relates_ServiceOffering_KnowledgeArticle] as KnowledgeArticleServiceOfferingsFromSource
...
INSERT [ServiceManagement].[dbo].[Announcement] 
	([ID] ,[Priority] ,[Title] ,[Body] ,[AccessGroupId] ,[StartDate] ,[EndDate] )
		...
		FROM [ServiceManagementOld].[dbo].[Announcement] as AnnouncementFromSource
...
INSERT [ServiceManagement].[dbo].[WatchList] 
	([UserId] ,[WorkItemId])
		...
		FROM [ServiceManagementOld].[dbo].[WatchList] as WatchListFromSource
...
inner join ServiceManagement_Prod_20210105.dbo.WorkItem as ServiceManagementWorkItem
